...
public:
    ...
    void loadSynthControlObjects() {
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1_ENV_DEST", "LFO1 envelope destination", "button2", -1, 60, -1, 126, "direct", 2, false, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1_ENV_P", "LFO1 envelope polarity", "button2", -1, 65, -1, 132, "direct", 1, false, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1_SYNC", "LFO1 sync", "button2", -1, 58, -1, 125, "direct", 2, false, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2_ENV_DEST", "LFO2 envelope destination", "button2", -1, 61, -1, 128, "direct", 2, false, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2_ENV_P", "LFO2 envelope polarity", "button2", -1, 66, -1, 133, "direct", 1, false, true));
