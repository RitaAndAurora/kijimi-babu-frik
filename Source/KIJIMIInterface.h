...
public:
    ...
    void loadSynthControlObjects() {
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1VCO1_P", "LFO1 to VCO1 polarity", "button2", 88, 103, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1VCO2_P", "LFO1 to VCO2 polarity", "button2", 89, 104, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1WAVE1_P", "LFO1 to WAVE1 polarity", "button2", 90, 105, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1WAVE2_P", "LFO1 to WAVE2 polarity", "button2", 91, 106, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1SUB_P", "LFO1 to SUB polarity", "button2", 92, 107, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1VCF_P", "LFO1 to VCF polarity", "button2", 93, 108, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1RESO_P", "LFO1 to RESO polarity", "button2", 94, 109, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1VCA_P", "LFO1 to VCA polarity", "button2", 95, 110, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2_AMT", "LFO2 amount", "knob", 8, 6, "direct", 127, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2VCO1_P", "LFO2 to VCO1 polarity", "button2", 102, 111, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2VCO2_P", "LFO2 to VCO2 polarity", "button2", 103, 112, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2WAVE1_P", "LFO2 to WAVE1 polarity", "button2", 104, 113, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2WAVE2_P", "LFO2 to WAVE2 polarity", "button2", 105, 114, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2SUB_P", "LFO2 to SUB polarity", "button2", 106, 115, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2VCF_P", "LFO2 to VCF polarity", "button2", 14, 116, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2RESO_P", "LFO2 to RESO polarity", "button2", 108, 117, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2VCA_P", "LFO2 to VCA polarity", "button2", 109, 118, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR2_AMT", "ADSR2 amount", "knob", 40, 7, "direct", 127, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR2VCO1_P", "ADSR2 to VCO1 polarity", "button2", 110, 119, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR2VCO2_P", "ADSR2 to VCO2 polarity", "button2", 15, 120, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR2WAVE1_P", "ADSR2 to WAVE1 polarity", "button2", 112, 121, "80_16_48_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR2WAVE2_P", "ADSR2 to WAVE2 polarity", "button2", 113, 122, "80_16_48_112", 3, true, true));
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO1_SHAPE", "LFO1 shape", "button0", 114, 53, "115_94_73_52_31_10", 5, true, true));
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO2_SHAPE", "LFO2 shape", "button0", 116, 54, "115_94_73_52_31_10", 5, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_LFO_ENV", "LFO envelope", "button2", 115, 55, "16_48_80_112", 3, true, true));
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_VCO1_VOL13", "VCO1 volume 1/3", "button1", 117, 56, "32_96", 1, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_VCO1_VOL23", "VCO1 volume 2/3", "button1", 118, 57, "32_96", 1, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_SUB_VOL", "Sub volume", "knob", 63, 30, "direct", 127, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_NOISE_VOL13", "Noise volume 1/3", "button1", 38, 58, "32_96", 1, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_NOISE_VOL23", "Noise volume 2/3", "button1", 39, 59, "32_96", 1, true, true));
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_VCO_SYNC", "VCO sync", "button2", 37, 60, "21_63_105", 2, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_VCO_KOFF", "VCO key off", "button2", 36, 61, "16_48_80_112", 3, true, true));
        ...
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR_MULT", "ADSR mult", "button2", 35, 62, "-_16_48_80_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR_CYCLE", "ADSR cycle", "button2", 34, 63, "16_48_80_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_ADSR_KT", "ADSR KT", "button2", 33, 64, "16_48_80_112", 3, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_GLIDE_RATE", "Glide rate", "knob", 86, 51, "direct", 127, true, true));
        synthControls.push_back(KIJIMISynthControl("KIJIMI_GLIDE_MODE", "Glide mode", "button2", 32, 79, "21_63_105", 2, true, true));
